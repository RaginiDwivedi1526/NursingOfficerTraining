...
import { Menu, X, Rocket, LayoutDashboard, ClipboardList, LogOut, Shield, BookOpen } from 'lucide-react';
      ...
      <div className={`nav-links ${isOpen ? 'open' : ''}`}>
        ...
        {user ? (
          <>
            ...
            <Link to="/library" onClick={closeMenu}><BookOpen size={14} className="nav-icon" /> E-Library</Link>
